...
use UNTDF\ReservasAulasBundle\Form\DocenteType;
...
class DocenteController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('UNTDFReservasAulasBundle:Docente')->findAll();

        return $this->render('UNTDFReservasAulasBundle:Docente:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('UNTDFReservasAulasBundle:Docente:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('UNTDFReservasAulasBundle:Docente')->find($id);
        ...
        return $this->render('UNTDFReservasAulasBundle:Docente:show.html.twig', array(
            'entity'      => $entity,
